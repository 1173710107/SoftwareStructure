...
public class CircularOrbitHelper {
  ...
  public static void visualize(ArrayList<Integer> nums) {
    ...
    for (int i = 1; i < numOfTracks; i++) {
      ...
      for (int j = 0; j < nums.get(i); j++) {
        pic.add(new Circle((int) (450 + r * Math.cos(sitha * j)),
            (int) (400 + r * Math.sin(sitha * j)), 5));
      }
    }
    ...
    for (int i = 1; i < numOfTracks; i++) {
      ...
      for (int j = 0; j < nums.get(i); j++) { // 针对每一个物体
        ...
        pic.add(new Circle((int) (450 + r * Math.cos(sitha * j)),
            (int) (400 + r * Math.sin(sitha * j)), 5));
        if (i == 1) {
          track1.add(new position((int) (450 + r * Math.cos(sitha * j)),
              (int) (400 + r * Math.sin(sitha * j))));
        }
        pos.put(ite.next(), new position((int) (450 + r * Math.cos(sitha * j)),
            (int) (400 + r * Math.sin(sitha * j))));
      }
    }
   ...
   * a.add(9); a.add(7); a.add(11); a.add(12); a.add(18); visualize(new
   * SocialNetworkCircle("txt/SocialNetworkCircle_Medium.txt")); }
   */
}
