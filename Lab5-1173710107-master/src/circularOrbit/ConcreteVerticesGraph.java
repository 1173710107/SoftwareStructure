...
public class ConcreteVerticesGraph<L> implements Graph<L> {
  ...
  // TODO toString()
  /*
   * public static void main(String[] args) { ConcreteVerticesGraph<String> test = new
   * ConcreteVerticesGraph<String>(); test.add("first"); test.add("second"); test.add("third");
   * test.add("fourth"); System.out.println(">>After add four things."); System.out.println(test);
   * test.set("first", "second", 1); test.set("first", "third", 3); test.set("first", "fourth", 4);
   * test.set("second", "third", 2); System.out.println(">>After add four edges.");
   * System.out.println(test); test.remove("first"); System.out.println(">>remove the first.");
   * System.out.println(test); test.set("fifth", "sixth", 5);
   * System.out.println(">>Add two vertexs while add edge."); System.out.println(test);
   * test.set("second", "third", 0); System.out.println(">>Remove a edge using set.");
   * System.out.println(test); System.out.println(test.getPair()); }
   */
}


/**
 * TODO specification Mutable. This class is internal to the rep of ConcreteVerticesGraph.
 * 
 * <p>
