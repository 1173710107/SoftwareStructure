...
public class monkey extends Thread {
  ...
  private int findLadder() {
    /*
     * int method = (int) (Math.random() + 1.5); ladderchoice strategy; if (method == 1) { strategy
     * = new ladderchoice1(); } else { strategy = new ladderchoice2(); }
     */
    ladderchoice strategy = new ladderchoice1();
